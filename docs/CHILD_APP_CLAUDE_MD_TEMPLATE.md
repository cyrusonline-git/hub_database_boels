...
Publiceer ook `core-users.php` met `{"users":[{"email","roles":[slugs]}]}`
— alleen Boels-medewerkers, nooit klant-accounts — zodat CORE bij het
koppelen ook de rol-toekenningen automatisch overneemt. Beveilig het met
