<?php
/**
 * Boels CORE — Eenmalig: bp.boels.sorai.nl toevoegen aan
...
echo "Boels CORE — bp.boels.sorai.nl toevoegen aan Sanctum\n" . str_repeat('=', 50) . "\n\n";

if (preg_match('/^SANCTUM_STATEFUL_DOMAINS=(.*)$/m', $contents, $sm)) {
    $domains = array_filter(array_map('trim', explode(',', $sm[1])));
    if (in_array('bp.boels.sorai.nl', $domains)) {
        echo "bp.boels.sorai.nl stond er al in.\n";
    } else {
        $domains[] = 'bp.boels.sorai.nl';
